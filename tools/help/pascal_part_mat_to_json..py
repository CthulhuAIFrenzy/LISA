...
if __name__ == '__main__':
    ...
    parser.add_argument('--split_path', default='vlpart/pascal_part/VOCdevkit/VOC2010/ImageSets/Main')
    parser.add_argument('--split', default='train.txt')
    parser.add_argument('--ann_path', default='vlpart/pascal_part/Annotations_Part')
    parser.add_argument('--ann_out', default='vlpart/pascal_part/train.json')
